...
- Analyzing Top customers by their Order frequency
- Product Profitability: Checking which product categories drive the highest sales or revenue 
- Examing the low and high performning provinces and regions in terms of sales and purchase.
- Analysing various shipping cost with respect to order of priority.
- Measuring customer satisfaction with profitability.

# Tools Used
- SQL: For cleaning Dataset, Analysis

# Key Insights
- Analyzing Top customers by their Order of frequency
    - Top Customers ordered the most items with consequent increase in profit and sales

- The Techology product category returned the highest due to increase in demand in Tecnologyy.
   - Product Profitability: Checking which product categories drive the highest sales or revenue 
      
- Examining the low and high performning provinces and regions in terms of sales and purchase.
    
- Analysing various shipping cost with respect to order of priority and Ship Mode.
...
group by Province;
--% Ontarion returned with 202,346.84--------------
...
#### Findings
- The Analysis uncovers the growing demand for technology which accounts for the highest Sales with comensurate profit margin
- The Data reveals the decline in the demand for traditional equipment which in turn affects sales and overall revenue.
- The Bottom 10 have Low Order Count resulting in Low sales and values compared to the Top 10 Customers. 

#### Recommendation----------
- Increase in frequency and Volume of purchase to increase Sales and consequent revenues
- Focusing on excellent customer service through quick response times, personalized support and more convenient options for order and delivery ------
- Utilizing technology to build online presence to attract newer customers to increase sales in the bottom Category.
...
- The huge patronage of this ship Mode with consequent sales values adds significantly to the overall sales revenue.
- The selected Air ship mode was efficient for timely delivery of Critical orders and to satisfy high-end valued customers
...
# Results:
  - This Result shows that Technology is in high demand with the highest sales and most profitable customer from the Tecnology Product Category. This contributes significantly to the overall sales revenue.
  - The increased sales in the use of delivery Truck also shows that people want to have a good reason to pay more for certain services and if their product is not critical they'd rather follow through the delivery     process of this Ship Mode without dire consequencies.
  ...
  - A considerable percentage discount is needed to boost sales in products and products category with less sales.
